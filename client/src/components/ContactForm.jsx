        ...
        <div className='w-full flex items-center justify-center flex-col'>
            ...
            <div className='w-3/4 md:w-1/2 mb-8'>
                ...
                <div className="relative mt-2 rounded-md shadow-sm">
                    ...
                    <input type="name" name="name" id="name" className="block w-full rounded-md border-0 py-1.5 pl-10 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 outline-none focus:ring-transparent" placeholder="Your Name"/>
                </div>
            </div>
            ...
            <div className='w-3/4 md:w-1/2 mb-8'>
                ...
                <div className="relative mt-2 rounded-md shadow-sm">
                    ...
                    <input type="email" name="email" id="email" className="block w-full rounded-md border-0 py-1.5 pl-10 text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 outline-none focus:ring-transparent" placeholder="email@example.com"/>
                </div>
            </div>
            ...
            <button className="border-2 border-black bg-white py-2 px-8 font-extralight hover:text-white hover:border-white hover:bg-blue-600 text-black hover:text-normal transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110 hover:after:content-['📫'] after:content-['📪'] mb-[4rem] md:mb-0">Submit </button>
