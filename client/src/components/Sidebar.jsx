              ...
              <div className="flex items-center justify-between">
                <div className="-mr-2">
                  <Popover.Button className="p-2 inline-flex items-center justify-center text-black">
                    ...
                    <XMarkIcon className="h-6 w-6 lg:h-9 lg:w-9 text-blue-600 transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-110" aria-hidden="true" />
                  </Popover.Button>
                </div>
              </div>
              <div className="mt-6">
